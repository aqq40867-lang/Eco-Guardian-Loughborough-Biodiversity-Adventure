...
const BiodiversityGallery = ({ onViewAnimal }) => {
  ...
  const speciesData = {
    Mammals: [
      {
        name: 'Red Fox',
        fact: 'A clever hunter of the night',
        img: FoxImg,
        color: '#D6E8B1',
        link: '/animal/red-fox'
      },
      ...
      {
        name: 'Ferret',
        fact: 'Quick and agile underground explorer',
        img: FerretImg,
        color: '#B4D3D8',
        link: '/animal/ferret'
      },
      ...
      {
        name: 'Fallow Deer',
        fact: 'A gentle animal of woodland parks',
        img: DeerImg,
        color: '#F1F1E8',
        link: '/animal/fallow-deer'
      },

      {
        name: 'Grey Squirrel',
        fact: 'An energetic climber and food collector',
        img: SquirrelImg,
        color: '#F7C243',
        link: '/animal/grey-squirrel'
      },

      {
        name: 'Wild Rabbit',
        fact: 'A fast runner of open grasslands',
        img: RabbitImg,
        color: '#D6E8B1',
        link: '/animal/wild-rabbit'
      },

      {
        name: 'Water Vole',
        fact: 'A shy creature living near rivers',
        img: WaterVoleImg,
        color: '#B4D3D8',
        link: '/animal/water-vole'
      },

      {
        name: 'Wood Mouse',
        fact: 'A tiny forest animal active at night',
        img: WoodMouseImg,
        color: '#F7C243',
        link: '/animal/wood-mouse'
      }
    ],
    ...
    Birds: [
      {
        ...
        fact: 'A graceful bird of open wetlands',
        img: LapwingImg,
        color: '#B4D3D8',
        link: '/animal/northern-lapwing'
      },

      {
        name: 'Mallard Duck',
        fact: 'A common duck often seen on rivers',
        img: MallardImg,
        color: '#D6E8B1',
        link: '/animal/mallard-duck'
      },

      {
        name: 'Mandarin Duck',
        fact: 'Known for its colourful feathers',
        img: MandarinImg,
        color: '#F1F1E8',
        link: '/animal/mandarin-duck'
      },

      {
        name: 'Pied Avocet',
        fact: 'A striking wading bird with a curved bill',
        img: AvocetImg,
        color: '#E8714C',
        link: '/animal/pied-avocet'
      },

      {
        name: 'Common Buzzard',
        fact: 'A soaring bird of prey with sharp eyesight',
        img: BuzzardImg,
        color: '#F7C243',
        link: '/animal/common-buzzard'
      },

      {
        name: 'Mute Swan',
        fact: 'An elegant bird often found on lakes',
        img: MuteSwan,
        color: '#D6E8B1',
        link: '/animal/mute-swan'
      },

      {
        name: 'Peregrine Falcon',
        fact: 'One of the fastest birds in the world',
        img: PeregrineFalconImg,
        color: '#B4D3D8',
        link: '/animal/peregrine-falcon'
      }
    ],
    ...
    'Amphibians & Reptiles': [
      {
        name: 'Common Lizard',
        fact: 'A sun-loving reptile often seen on rocks',
        img: CommonLizardImg,
        color: '#B4D3D8',
        link: '/animal/common-lizard'
      },

      {
        name: 'Common Toad',
        fact: 'A slow-moving amphibian found in damp habitats',
        img: CommonToadImg,
        color: '#D6E8B1',
        link: '/animal/common-toad'
      },

      {
        name: 'Grass Snake',
        fact: 'A harmless snake that lives near water',
        img: GrassSnakeImg,
        color: '#F1F1E8',
        link: '/animal/grass-snake'
      },

      {
        name: 'Great Crested Newt',
        fact: 'A rare newt with a distinctive spiky crest',
        img: GreatCrestedNewtImg,
        color: '#E8714C',
        link: '/animal/great-crested-newt'
      },

      {
        name: 'Red-eared Terrapin',
        fact: 'A freshwater turtle with bright red markings',
        img: RedEaredTerrapinImg,
        color: '#F7C243',
        link: '/animal/red-eared-terrapin'
      },

      {
        name: 'Common Frog',
        fact: 'A familiar amphibian with a croaking call',
        img: CommonFrogImg,
        color: '#B4D3D8',
        link: '/animal/common-frog'
      }
    ]
  };
      ...
      <div className="gallery-showcase-frame">
        ...
        <div className="gallery-showcase-header">
          <span className="gallery-badge">
            LOUGHBOROUGH WILDLIFE
          </span>

          <h2>
            🌿 Loughborough Wildlife Explorer
          </h2>

          <p>
            Discover some of the most iconic wildlife
            species around Loughborough and learn
